 ...
 * WhatsAppButton
 * --------------
 * Floating WhatsApp action button pinned to the right edge of the viewport.
 * Rendered at the App level so it stays visible across every page.
 */
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_36px_-10px_rgba(37,211,102,0.9)] transition-transform duration-300 hover:-translate-y-1 hover:scale-105"
    >
