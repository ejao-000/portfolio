...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 text-[#25D366] drop-shadow-[0_0_10px_rgba(37,211,102,0.55)] transition-transform duration-300 hover:-translate-y-1 hover:scale-110"
    >
